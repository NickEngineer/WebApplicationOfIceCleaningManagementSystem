...
public class UserController {
    ...
    ModelAndView checkUser(@ModelAttribute("userFromServer") User user) {
        ...
        ModelAndView modelAndViewStyle =
                new ModelAndView("/resources/theme0/css/invalidEnterSystemPageStyle.css");
    ...
    ModelAndView getPrivateCab() {
        ModelAndView privateCabinetModelAndView =
                new ModelAndView("PrivateCabinet");
    ...
    @RequestMapping(value = "/resources/css/photos/futuristic_architecture_landscape.jpeg", method = RequestMethod.GET)
    public ModelAndView getFuturisticLandscape() {
        ModelAndView futuristicLandscapeModelAndView = new ModelAndView();
        futuristicLandscapeModelAndView.addObject(
                "landscape",
                "futuristic_architecture_landscape.jpeg");

        return futuristicLandscapeModelAndView;
    }

    @RequestMapping(value = "/resources/css/photos/Ok.jpg", method = RequestMethod.GET)
    public ModelAndView getOkImage() {
        ModelAndView futuristicLandscapeModelAndView = new ModelAndView();
        futuristicLandscapeModelAndView.addObject(
                "Ok",
                "Ok.jpg");
